...
if "%~1"=="demo" (
  ...
  if not exist "%~dp0..\installation-test-reelle" mkdir "%~dp0..\installation-test-reelle"
  echo MODE REEL : les actions confirmees modifieront Docker et les dossiers choisis.
  echo Projet isole dans "%~dp0..\installation-test-reelle".
  echo Choisissez aussi un nom de pile, CONFIG_ROOT et DATA_ROOT reserves au test.
  ".venv-web-local\Scripts\python.exe" -m plugarr --lang fr web --project-dir "%~dp0..\installation-test-reelle"
) else if "%~1"=="tui" (
