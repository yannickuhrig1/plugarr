...
def topology(cfg, saved=None):
    ...
    # autobrr sait pousser vers les *arr et les clients TORRENT. Son API ne
    # connait aucun type SABnzbd/Usenet : dessiner cette liaison revenait a
    # promettre celle qui faisait echouer le cablage en conditions reelles.
