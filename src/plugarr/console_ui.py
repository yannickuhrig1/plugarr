...
#veille-conteneurs{width:100%;border-collapse:collapse}#veille-conteneurs th,#veille-conteneurs td{text-align:left;padding:8px;border-bottom:1px solid var(--line)}
#veille-conteneurs tr.veille-alerte td{color:var(--warn-line);font-weight:600}
...
VEILLE = '''<section class="console-panel" id="veille"><h2>Veille</h2><p>Lecture seule, rafraîchie toutes les 5 secondes tant que cette page est affichée.</p><h3>Débits</h3><div id="veille-debits" class="summary-grid"></div><h3>Sortie du VPN</h3><p id="veille-vpn">Lecture…</p><h3>Disques</h3><div id="veille-disques"></div><div id="veille-conteneurs-bloc" hidden><h3>Conteneurs</h3><table id="veille-conteneurs"><thead><tr><th>Conteneur</th><th>État</th><th>Processeur</th><th>Mémoire</th><th>Redémarrages</th></tr></thead><tbody></tbody></table></div><p id="veille-etat" class="note" role="status"></p></section>'''
